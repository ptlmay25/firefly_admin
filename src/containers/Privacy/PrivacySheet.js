const PrivacySheet = [
    ...
    },
    {
        ...
        content: [
            ...
            '[Adobe Privacy Choices Page] [Crazy Egg Opt-Out Feature] [Clicktale Opt-Out Feature] Digital Advertising Alliance Opt-Out Tool',
            '[Flurry Analytics Yahoo Opt-Out Manager] [Google Analytics Opt-Out Plugin] [Google Ads Settings Page] [Inspectlet Opt-Out Cookie] [Kissmetrics Opt-Out Feature] [Mixpanel Opt-Out Cookie]',
        ]
    },

    {
        title: 'Network Advertising Initiative Opt-Out Tool',
        content: [
